! function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("Bulma", [], e) : "object" == typeof exports ? exports.Bulma = e() : t.Bulma = e()
}(window, (function () {
    return function (t) {
        var e = {};
        ...
        function a(t) {
            return this instanceof a ? t instanceof a ? t : (t instanceof HTMLElement ? this._elem = t : this._elem = document.querySelector(t), t || (this._elem = document.createElement("div")), this._elem.hasOwnProperty(a.id) || (this._elem[a.id] = i.default.uid++), this) : new a(t)
        }
        a.VERSION = "0.12.0", a.id = "bulma-" + (new Date).getTime(), a.cache = new i.default, a.plugins = {}, a.create = function (t, e) {
            if (!t || !a.plugins.hasOwnProperty(t)) throw new Error("[BulmaJS] A plugin with the key '" + t + "' has not been registered.");
            ...
            a.each(e, (function (e) {
                a.plugins[e].handler.hasOwnProperty("parseDocument") ? a.plugins[e].handler.parseDocument(t) : console.error("[BulmaJS] Plugin " + e + " does not have a parseDocument method. Automatic document parsing is not possible for this plugin.")
            }))
            ...
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : document,
                ...
                o = e.querySelector(t);
            if (!o) {
                0 === r.length && (r = t.split(".").filter((function (t) {
                    return t
                })));
            ...
            return new Promise((function (e, n) {
                ...
                r.open("GET", t, !0), r.onload = function () {
                    r.status >= 200 && r.status < 400 ? e(a._stripScripts(r.responseText)) : n()
                }, r.onerror = function () {
                    return n()
                }, r.send()
            }))
            ...
            e.innerHTML = t;
            for (var n = e.getElementsByTagName("script"), r = n.length; r--;) n[r].parentNode.removeChild(n[r]);
            return e.innerHTML.replace(/  +/g, " ")
        }, a.getGlobalConfig = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            return window.hasOwnProperty("bulmaOptions") && window.bulmaOptions.hasOwnProperty(t) ? window.bulmaOptions[t] : e
        }, a.prototype.data = function (t, e) {
            return e ? (a.cache.set(this._elem[a.id], t, e), this) : a.cache.get(this._elem[a.id], t)
        ...
        var u = function () {
            function t() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    n = arguments[1];
                if (l(this, t), e.root = n instanceof a.default ? n._elem : n, this.config = new i.default(r({}, this.constructor.defaultConfig(), e)), !n && !this.config.has("parent")) throw new Error("A plugin requires a root and/or a parent.");
            ...
            return o(t, null, [{
                ...
                value: function (t) {
                    ...
                    if (this._events.hasOwnProperty(t))
                        for (var n = 0; n < this._events[t].length; n++) this._events[t][n](e)
                }
            }, {
                key: "destroy",
                value: function () {
        ...
        var o = function () {
            ...
            return r(t, [{
                ...
                value: function (t, e, n) {
                    this._data.hasOwnProperty(t) || (this._data[t] = {}), this._data[t][e] = n
                }
            }, {
                key: "get",
                value: function (t, e) {
        ...
        var a = function () {
            function t() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
                if (i(this, t), "object" !== (void 0 === e ? "undefined" : r(e))) throw new TypeError("initialConfig must be of type object.");
                this._items = e
            }
            return o(t, [{
                key: "set",
                value: function (t, e) {
                    if (!t || !e) throw new Error("A key and value must be provided when setting a new option.");
                    this._items[t] = e
                }
            }, {
                key: "has",
                ...
                value: function (t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                    return e && !this.has(t) ? "function" == typeof e ? e() : e : this._items[t]
                }
            }]), t
        }();
        e.default = a
        ...
        var l = e.Navbar = function (t) {
            ...
            return function (t, e) {
                ...
                value: function (t) {
                    var e = void 0;
                    e = "object" === r(t.classList) && t.classList.contains("navbar") ? [t] : t.querySelectorAll(".navbar"), i.default.each(e, (function (t) {
                        (0, i.default)(t).navbar({
                            sticky: !!t.hasAttribute("data-sticky"),
                            stickyOffset: t.hasAttribute("data-sticky-offset") ? t.getAttribute("data-sticky-offset") : 0,
                            hideOnScroll: !!t.hasAttribute("data-hide-on-scroll"),
                            tolerance: t.hasAttribute("data-tolerance") ? t.getAttribute("data-tolerance") : 0,
                            hideOffset: t.hasAttribute("data-hide-offset") ? t.getAttribute("data-hide-offset") : null,
                ...
                value: function () {
                    var t = this;
                    this.triggerElement.addEventListener("click", this.handleTriggerClick.bind(this)), this.sticky && this.enableSticky(), i.default.each(this.dropdowns, (function (e) {
