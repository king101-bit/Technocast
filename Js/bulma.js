! function (e, t) {
    ...
    return function (e) {
        ...
        function a(e) {
            return this instanceof a ? e instanceof a ? e : (e instanceof HTMLElement ? this._elem = e : this._elem = document.querySelector(e), e || (this._elem = document.createElement("div")), this._elem.hasOwnProperty(a.id) || (this._elem[a.id] = i.default.uid++), this) : new a(e)
        }
        a.VERSION = "0.12.0", a.id = "bulma-" + (new Date).getTime(), a.cache = new i.default, a.plugins = {}, a.create = function (e, t) {
            ...
            a.each(t, (function (t) {
                a.plugins[t].handler.hasOwnProperty("parseDocument") ? a.plugins[t].handler.parseDocument(e) : console.error("[BulmaJS] Plugin " + t + " does not have a parseDocument method. Automatic document parsing is not possible for this plugin.")
            }))
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : document,
                ...
                r = t.querySelector(e);
            if (!r) {
                0 === o.length && (o = e.split(".").filter((function (e) {
                    return e
                })));
            ...
            return window.hasOwnProperty("bulmaOptions") && window.bulmaOptions.hasOwnProperty(e) ? window.bulmaOptions[e] : t
            ...
            a.getGlobalConfig("autoParseDocument", !0) && a.parseDocument(), a.getGlobalConfig("onLoaded") && a.getGlobalConfig("onLoaded")()
        })), t.default = a
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
        ...
        var u = function () {
            function e() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    n = arguments[1];
                if (l(this, e), t.root = n instanceof a.default ? n._elem : n, this.config = new i.default(o({}, this.constructor.defaultConfig(), t)), !n && !this.config.has("parent")) throw new Error("A plugin requires a root and/or a parent.");
            ...
            return r(e, null, [{
                ...
                value: function (e) {
                    ...
                    if (this._events.hasOwnProperty(e))
                        for (var n = 0; n < this._events[e].length; n++) this._events[e][n](t)
                }
            }, {
                key: "destroy",
                value: function () {
        ...
        var a = function (e) {
            ...
            return function (e, t) {
                ...
                value: function () {
                    ...
                    })(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "destroy", this).call(this), this.closeButton && this.closeButton.removeEventListener("click", this.handleCloseEvent.bind(this)), clearInterval(this.dismissInterval), this.parent.getElement().removeChild(this.root), this.parent = null, this.root = null, this.trigger("destroyed")
                }
            }]), t
        }(i(n(1)).default);
        t.default = a
        ...
        var s = t.Modal = function (e) {
            function t(e, n) {
                ...
                return o.style = o.config.get("style"), o.root = o.config.get("root"), o.root.classList.contains("modal") || o.root.classList.add("modal"), o.parent ? o.parent.appendChild(o.root) : o.root.parentNode ? o.parent = o.root.parentNode : (o.parent = document.body, o.parent.appendChild(o.root)), o.background = r.default.findOrCreateElement(".modal-background", o.root), o.content = "card" === o.style ? r.default.findOrCreateElement(".modal-card", o.root) : r.default.findOrCreateElement(".modal-content", o.root), o.closable = o.config.get("closable"), o.body = o.config.get("body"), o.title = o.config.get("title"), o.config.get("bodyUrl") ? r.default.ajax(o.config.get("bodyUrl")).then((function (e) {
                    o.body = e, o.buildModal()
                })) : o.buildModal(), (0, r.default)(o.root).data("modal", o), o.trigger("init"), o
            }
            return function (e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                key: "buildModal",
                value: function () {
                    "card" === this.style ? this.createCardStructure() : this.content.innerHTML || (this.content.innerHTML = this.body), this.closable && (this.closeButton = "card" === this.style ? r.default.findOrCreateElement(".delete", this.header, "button") : r.default.findOrCreateElement(".modal-close", this.root, "button")), "card" === this.style && this.createButtons(), this.setupEvents()
                }
            }, {
                key: "createCardStructure",
                value: function () {
                    this.header = r.default.findOrCreateElement(".modal-card-head", this.content, "header"), this.headerTitle = r.default.findOrCreateElement(".modal-card-title", this.header, "p"), this.headerTitle.innerHTML || (this.headerTitle.innerHTML = this.title), this.cardBody = r.default.findOrCreateElement(".modal-card-body", this.content, "section"), this.cardBody.innerHTML || (this.cardBody.innerHTML = this.body), this.footer = r.default.findOrCreateElement(".modal-card-foot", this.content, "footer")
                }
            }, {
                key: "setupEvents",
                value: function () {
                    var e = this;
                    this.closable && (this.closeButton.addEventListener("click", this.close.bind(this)), this.keyupListenerBound = function (t) {
                        return e.keyupListener(t)
                    }, document.addEventListener("keyup", this.keyupListenerBound), this.background.addEventListener("click", this.close.bind(this)))
                }
            }, {
                key: "createButtons",
                value: function () {
                    ...
                    r.default.each(e, (function (e) {
                        ...
                        n.innerHTML = e.label, n.addEventListener("click", (function (t) {
                            e.onClick(t)
        ...
        var l = t.Notification = function (e) {
            function t(e, n) {
                ! function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t);
                ...
                return o.isDismissable && (o.config.has("closeButton") || o.prependCloseButton(), o.setupCloseEvent()), (0, i.default)(o.root).data("notification", o), o.trigger("init"), o
            }
            return function (e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                value: function (e) {
                    var t = void 0;
                    t = "object" === o(e.classList) && e.classList.contains("notification") ? [e] : e.querySelectorAll(".notification"), i.default.each(t, (function (e) {
                        var t = (0, i.default)(e);
        ...
        i.default.registerPlugin("notification", l), t.default = i.default
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var l = t.Navbar = function (e) {
            ...
            return function (e, t) {
                ...
                value: function (e) {
                    var t = void 0;
                    t = "object" === o(e.classList) && e.classList.contains("navbar") ? [e] : e.querySelectorAll(".navbar"), i.default.each(t, (function (e) {
                        (0, i.default)(e).navbar({
                ...
                value: function () {
                    var e = this;
                    this.triggerElement.addEventListener("click", this.handleTriggerClick.bind(this)), this.sticky && this.enableSticky(), i.default.each(this.dropdowns, (function (t) {
                        t.addEventListener("click", e.handleDropdownTrigger)
                    }))
                }
            }, {
                ...
                key: "toggleSticky",
                value: function (e) {
                    if (e > this.stickyOffset ? (this.root.classList.add("is-fixed-top"), document.body.classList.add("has-navbar-fixed-top"), this.shadow && this.root.classList.add("has-shadow")) : (this.root.classList.remove("is-fixed-top"), document.body.classList.remove("has-navbar-fixed-top"), this.shadow && this.root.classList.remove("has-shadow")), this.hideOnScroll) {
        ...
        i.default.registerPlugin("navbar", l), t.default = i.default
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var l = t.Message = function (e) {
            function t(e, n) {
                ...
                return o.size = o.config.get("size"), o.title = o.config.get("title"), o.title && o.createMessageHeader(), o.isDismissable && (o.config.get("closeButton") || o.prependCloseButton(), o.setupCloseEvent()), o.size && o.setSize(), (0, i.default)(o.root).data("message", o), o.trigger("init"), o
            }
            return function (e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                value: function (e) {
                    var t = void 0;
                    t = "object" === o(e.classList) && e.classList.container(".message") ? [e] : e.querySelectorAll(".message"), i.default.each(t, (function (e) {
        ...
        i.default.registerPlugin("message", l), t.default = i.default
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var l = t.Dropdown = function (e) {
            function t(e, n) {
                ...
                return o.root = o.config.get("root"), o.root.setAttribute("data-bulma-attached", "attached"), o.triggerElement = o.root.querySelector(".dropdown-trigger"), o.registerEvents(), (0, i.default)(o.root).data("dropdown", o), o.trigger("init"), o
            }
            return function (e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                value: function (e) {
                    var t = void 0;
                    t = "object" === o(e.classList) && e.classList.contains("dropdown") ? [e] : e.querySelectorAll(".dropdown"), i.default.each(t, (function (e) {
                        (0, i.default)(e).dropdown()
                    }))
                }
            }]), r(t, [{
                key: "registerEvents",
        ...
        i.default.registerPlugin("dropdown", l), t.default = i.default
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var u = t.Alert = function (e) {
            ...
            return function (e, t) {
                ...
                value: function () {
                    ...
                    this.cardBody = s.default.findOrCreateElement(".modal-card-body", this.content, "section"), this.cardBody.innerHTML || (this.cardBody.innerHTML = this.body), this.footer = s.default.findOrCreateElement(".modal-card-foot", this.content, "footer")
                }
            }, {
                key: "createButtons",
                value: function () {
                    ...
                    if (o.innerHTML = n.label, o.addEventListener("click", (function (t) {
                            n.onClick(t), n.close && e.close(), n.destroy && e.destroy()
                        })), this.footer.appendChild(o), this.config.get("cancel")) {
                        ...
                        a.innerHTML = i.label, a.addEventListener("click", (function (t) {
        ...
        var l = t.File = function (e) {
            function t(e, n) {
                ...
                return o.root = o.config.get("root"), o.root.setAttribute("data-bulma-attached", "attached"), o.input = o.root.querySelector("input"), o.filename = o.root.querySelector(".file-name"), o.registerEvents(), (0, i.default)(o.root).data("file", o), o.trigger("init"), o
            }
            return function (e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                value: function (e) {
                    var t = void 0;
                    t = "object" === o(e.classList) && e.classList.contains("file") ? [e] : e.querySelectorAll(".file"), i.default.each(t, (function (e) {
                        (0, i.default)(e).file()
                    }))
                }
            }]), r(t, [{
                ...
                value: function () {
                    var e = this;
                    this.filename && this.input.addEventListener("change", this.handleTriggerChange.bind(this)), this.root.addEventListener("dragover", (function (t) {
                ...
                value: function (e) {
                    0 === e.target.files.length && this.clearFileName(), 1 === e.target.files.length && this.setFileName(e.target.files[0].name), e.target.files.length > 1 && this.setFileName(e.target.files.length + " files"), this.trigger("changed", e)
                }
            }, {
                key: "clearFileName",
                value: function () {
        ...
        i.default.registerPlugin("file", l), t.default = i.default
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var l = t.Tabs = function (e) {
            function t(e, n) {
                ...
                return o.root = o.config.get("root"), o.root.setAttribute("data-bulma-attached", "attached"), o.hover = o.config.get("hover"), o.nav = o.findNav(), o.navItems = o.findNavItems(), o.content = o.findContent(), o.contentItems = o.findContentItems(), o.setupNavEvents(), (0, i.default)(o.root).data("tabs", o), o.trigger("init"), o
            }
            return function (e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                value: function (e) {
                    var t = void 0;
                    t = "object" === o(e.classList) && e.classList.has("tabs-wrapper") ? [e] : e.querySelectorAll(".tabs-wrapper"), i.default.each(t, (function (e) {
                        (0, i.default)(e).tabs({
                ...
                value: function () {
                    ...
                    i.default.each(this.navItems, (function (t, n) {
                        t.addEventListener("click", (function () {
                            e.setActive(n)
                        })), e.hover && t.addEventListener("mouseover", (function () {
                            e.setActive(n)
                        }))
                    }))
                }
        ...
        i.default.registerPlugin("tabs", l), t.default = i.default
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var l = t.PanelTabs = function (e) {
            function t(e, n) {
                ...
                return o.root = o.config.get("root"), o.root.setAttribute("data-bulma-attached", "attached"), o.nav = o.findNav(), o.navItems = o.findNavItems(), o.contentItems = o.findContentItems(), o.setupNavEvents(), (0, i.default)(o.root).data("panelTabs", o), o.trigger("init"), o
            }
            return function (e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                e.prototype = Object.create(t && t.prototype, {
                ...
                value: function (e) {
                    var t = void 0;
                    t = "object" === o(e.classList) && e.classList.contains("panel") ? [e] : e.querySelectorAll(".panel"), i.default.each(t, (function (e) {
                        null !== e.querySelector(".panel-tabs") && (0, i.default)(e).panelTabs()
                    }))
                }
            }, {
                key: "defaultConfig",
                ...
                value: function (e) {
                    this.navItems.forEach((function (t) {
                        ...
                        t.getAttribute("data-category") === e || null === e ? t.classList.remove("is-hidden") : t.classList.add("is-hidden")
                    }))
                }
            }]), t
        }(a.default);
        i.default.registerPlugin("panelTabs", l), t.default = i.default
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        n(6), n(7), n(8), n(9), n(5), n(10), n(11), n(12), n(13);
        t.default = i.default
    }]).default
}));